...
\begin{itemize}
	\item \textbf{Проверка установки пакета в системе}: \Sys{rpm -q ИМЯ\_ПАКЕТА}\\
	...
	\item \textbf{Информация о пакете}: \Sys{rpm -qi ИМЯ\_ПАКЕТА}\\
	...
	\item \textbf{Проверка зависимостей пакета}: \Sys{rpm -qR ИМЯ\_ПАКЕТА}\\
	...
	\item \textbf{Просмотр файлов пакета}: \Sys{rpm -ql ИМЯ\_ПАКЕТА}\\
	...
	\item \textbf{Проверка целостности пакета}: \Sys{rpm -V ИМЯ\_ПАКЕТА | ФАЙЛ\_ПАКЕТА}\\
...
\begin{verbatim}
    $ rpm -qip /путь/к/пакету/пакет.rpm
\end{verbatim}
