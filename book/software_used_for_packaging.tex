...
\begin{itemize}
	...
	\item \Emph{Gear} --- инструмент направленный на упрощение работы с источниками исходных данных пакетов,
		и облегчение процесса сборки пакетов встроенными в \Sys{Gear} инструментами \Sys{rpmbuild} и \Sys{hasher}.
\end{itemize}
...
\Emph{Сборочная зависимость пакета(зависимость для сборки)} --- вид \hyperlink{require-def}{зависимостей пакета}
...
Секция журнал изменений содержит оформленный в принятом сообществом формате журнал
...
\item Верно ли что \Sys{hasher} обеспечивает воспроизводимую сборку в контролируемой среде?
