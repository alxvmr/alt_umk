...
$ git clone ----branch=gear-v2 \
 https://gitlab.basealt.space/alt/edu/ExampleFirstProject.git ~/ExampleFirstProject-v2/
...
\marginalia{ex_sign_col}{Проверьте права доступа файлов источников для пакетов системы \Sys{/etc/apt/}.
	Хотябы один источни должен быть доступен на чтение для группы \Sys{hashman}.
